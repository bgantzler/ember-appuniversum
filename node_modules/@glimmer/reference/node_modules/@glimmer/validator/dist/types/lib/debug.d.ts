...
export declare let runInTrackingTransaction: undefined | ((fn: () => void, debuggingContext?: string | false) => void);
...
export declare let assertTagNotConsumed: undefined | (<T>(tag: Tag, obj?: T, keyName?: keyof T | string | symbol, forceHardError?: boolean) => void);
