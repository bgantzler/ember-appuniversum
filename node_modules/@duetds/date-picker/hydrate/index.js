...
const createTime = (e, t = "") => {
 ...
 const t = e.$cmpMeta$, o = e.$hostElement$, s = createTime("attachStyles", t.$tagName$), a = addStyle( o.getRootNode(), t);
 s();
...
const createElm = (e, t, o, n) => {
 ...
 if ( null !== r.$text$) s = r.$elm$ = doc.createTextNode(r.$text$); else {
  if ( !isSvgMode && (isSvgMode = "svg" === r.$tag$), s = r.$elm$ =  doc.createElementNS(isSvgMode ? "http://www.w3.org/2000/svg" : "http://www.w3.org/1999/xhtml",  r.$tag$) , 
 ...
 let l, r =  e;
 for (BUILD.shadowDom   ; s <= a; ++s) n[s] && (l = createElm(null, o, s), 
 l && (n[s].$elm$ = l, r.insertBefore(l,  t)));
}, removeVnodes = (e, t, o, n, s) => {
 for (;t <= o; ++t) (n = e[t]) && (s = n.$elm$, callNodeRefs(n), s.remove());
}, isSameVnode = (e, t) => e.$tag$ === t.$tag$ && (  e.$key$ === t.$key$), patch = (e, t) => {
 const o = t.$elm$ = e.$elm$, n = e.$children$, s = t.$children$, a = t.$tag$, l = t.$text$;
  null !== l ?   e.$text$ !== l && (o.data = l) : ( (isSvgMode = "svg" === a || "foreignObject" !== a && isSvgMode), 
  ...
  $ = t[++l], h = n[++r]; else if (isSameVnode(m, u)) patch(m, u), m = t[--c], u = n[--p]; else if (isSameVnode($, u)) patch($, u), e.insertBefore($.$elm$, m.$elm$.nextSibling), $ = t[++l], u = n[--p]; else if (isSameVnode(m, h)) patch(m, h), e.insertBefore(m.$elm$, $.$elm$), m = t[--c], h = n[++r]; else {
   if (i = -1, BUILD.vdomKey) for (d = l; d <= c; ++d) if (t[d] && null !== t[d].$key$ && t[d].$key$ === h.$key$) {
    ...
    i >= 0 ? (a = t[i], a.$tag$ !== h.$tag$ ? s = createElm(t && t[r], o, i) : (patch(a, h), 
   t[i] = void 0, s = a.$elm$), h = n[++r]) : (s = createElm(t && t[r], o, r), h = n[++r]), 
 ...
 a.$tag$ = null, a.$flags$ |= 4, e.$vnode$ = a, a.$elm$ = s.$elm$ =  o, 
 patch(s, a), 
 ...
 e.$queuedListeners$ = null)), BUILD.cmpWillLoad ) : (BUILD.cmpWillUpdate ), n(), then(a, () => updateComponent(e, s, t));
...
const callRender = (e, t) => {
 ...
 const t = e.$cmpMeta$.$tagName$, o = e.$hostElement$, n = createTime("postUpdate", t), a = e.$ancestorComponent$;
 64 & e.$flags$ ? (n()) : (e.$flags$ |= 64,  addHydratedFlag(o), 
 n(),  (e.$onReadyResolve$(o), a || appDidLoad())),  e.$onInstanceResolve$(o),  (e.$onRenderResolve$ && (e.$onRenderResolve$(), 
 ...
 i[5] ? a["s-sn"] = d.$name$ = i[5] : a["s-sn"] = "", a["s-sr"] = !0, o.push(d), e.$children$ || (e.$children$ = []), 
 e.$children$[d.$index$] = d) : "r" === r && ( BUILD.slotRelocation ))); else if (e && "style" === e.$tag$) {
 ...
 if (0 == (1 & plt.$flags$)) {
  ...
  if (1 & t.$flags$) addHostEventListeners(e, t, o.$listeners$), fireConnectedCallback(); else {
   ...
   if (t.$flags$ |= 1,  (n = e.getAttribute("s-id"), n)) {
    ((e, t, o, n) => {
     const s = createTime("hydrateClient", t), a = e.shadowRoot, l = [], r =  null, i = n.$vnode$ = newVNode(t, null);
...
const DatePickerInput = ({ onClick, localization, name, value, identifier, disabled, role, buttonRef, inputRef, onInput, onBlur, onFocus, }) => {
  return (hAsync("div", { class: "duet-date__input-wrapper" },
    hAsync("input", { class: "duet-date__input", name: name, value: value, placeholder: localization.placeholder, id: identifier, disabled: disabled, role: role, "aria-autocomplete": "none", onInput: onInput, onFocus: onFocus, onBlur: onBlur, autoComplete: "off", ref: inputRef }),
...
const DatePickerDay = ({ focusedDay, today, day, onDaySelect, onKeyboardNavigation, focusedDayRef, inRange, dateFormatter, }) => {
  ...
  return (hAsync("button", { class: {
    ...
    hAsync("span", { class: "duet-date__vhidden" }, dateFormatter(day))));
};
...
const DatePickerMonth = ({ selectedDate, focusedDate, labelledById, localization, firstDayOfWeek, min, max, dateFormatter, onDateSelect, onKeyboardNavigation, focusedDayRef, onMouseDown, onFocusIn, }) => {
  ...
  return (hAsync("table", { class: "duet-date__table", role: "grid", "aria-labelledby": labelledById, 
    // @ts-ignore
    ...
    hAsync("tbody", null, chunk(days, 7).map(week => (hAsync("tr", { class: "duet-date__row" }, week.map(day => (hAsync("td", { class: "duet-date__cell", role: "gridcell", "aria-selected": isEqual(day, selectedDate) ? "true" : undefined },
      hAsync(DatePickerDay, { day: day, today: today, focusedDay: focusedDate, inRange: inRange(day, min, max), onDaySelect: onDateSelect, dateFormatter: dateFormatter, onKeyboardNavigation: onKeyboardNavigation, focusedDayRef: focusedDayRef }))))))))));
};
