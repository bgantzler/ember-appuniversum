...
const callRender = (e, t) => {
 ...
 e.cloneNode = function(e) {
  ...
  if (appData.BUILD.slot && !o && e) {
   let e, t = 0;
   for (;t < a.childNodes.length; t++) e = a.childNodes[t]["s-nr"], e && (appData.BUILD.appendChildSlotFix && s.__appendChild ? s.__appendChild(e.cloneNode(!0)) : s.appendChild(e.cloneNode(!0)));
  }
  return s;
 };
