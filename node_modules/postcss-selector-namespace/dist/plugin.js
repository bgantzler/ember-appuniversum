...
module.exports = _postcss2.default.plugin('postcss-selector-namespace', (options = {}) => {
  var _options$namespace = options.namespace;
  let namespace = _options$namespace === undefined ? '.self' : _options$namespace;
  var _options$selfSelector = options.selfSelector;
  let selfSelector = _options$selfSelector === undefined ? /:--namespace/ : _options$selfSelector;
  var _options$rootSelector = options.rootSelector;
  let rootSelector = _options$rootSelector === undefined ? /:root/ : _options$rootSelector;
  var _options$ignoreRoot = options.ignoreRoot;
  let ignoreRoot = _options$ignoreRoot === undefined ? true : _options$ignoreRoot;
  var _options$dropRoot = options.dropRoot;
  let dropRoot = _options$dropRoot === undefined ? true : _options$dropRoot;
